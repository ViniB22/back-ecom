const { criarItemPedido, listarItensPedido, listarItensPedidoPorPedido,
...
async function listarPorPedido(req, res) {
    try {
        ...
        const itensPedido = await listarItensPedidoPorPedido(parseInt(idPedido))
...
async function atualizarCompleto(req, res) {
    try {
        ...
        return res.status(200).json({
            message: 'Item do pedido atualizado completamente com sucesso',
            itemPedido: itemPedidoAtualizado
        })
...
async function deletar(req, res) {
    try {
        ...
        return res.status(200).json({ message: 'Item do pedido apagado com sucesso' })
...
module.exports = { criar, listar, listarPorPedido, atualizar,
